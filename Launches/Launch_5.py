...
def Mission():
    ...
    Header.Left_Motor_M.run_target(1000, 850, then=Stop.HOLD, wait=True)
    Header.PID(-100, 0, 150, -5, -0.1, -10, 10, DF=2)
    Header.PID_TIME(-100, 0, 1000, -5, -0.1, -10, 10)
    Header.Left_Motor_M.run_target(1000, 400, then=Stop.HOLD)
    Header.reset_all()
    Header.PID(100, 0, 60, -5, -0.1, -10, 10)
    Header.Motor_Check(60)
    Header.P_Gyro_Turn(41, 4, 4, min_speed=100)
    Header.Gyro_Check(41)
    Header.ev3.screen.print(Header.Gyro_Sensor.angle())
    Header.wait(500)
    Header.PID_TIME(-600, 41, 1500, -5, -0.1, -10, 3)
    Header.PID(50, Header.Gyro_Sensor.angle(), 220, -5, -0.1, -10, 15)
    ...
    Header.P_Gyro_Turn(-71, 7, 7)
    Header.PID_COLOR_R(-500, -71, 82, 2, -5, -0.1, -10, 15)
    # Header.PID(-100, -73, 30, -5, -0.1, -10, 5)
